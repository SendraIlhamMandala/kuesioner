...
class Controller extends BaseController
{
    ...
    public function exportMatkul($matkul)
    {
        ...
        $htmlContent = '
            ...
            <tr>
            <td style="width: 19.1613%;">Mata Kuliah</td>
            <td style="width: 4.56481%;">:</td>
            <td style="width: 33.8642%;">' . $namaMatkul . ' </td>
            <td style="width: 20.2361%;"></td>
            <td style="width: 2.2425%;"></td>
            <td style="width: 19.9309%;"></td>
            </tr>
            <tr>
            <td style="width: 19.1613%;">Dosen</td>
            <td style="width: 4.56481%;">:</td>
            <td style="width: 33.8642%;"></td>
            <td style="width: 20.2361%;"></td>
            <td style="width: 2.2425%;"></td>
            <td style="width: 19.9309%;"></td>
            </tr>
        ...
        header("content-disposition: attachment;filename=" . 'survey_' . $namaMatkul . ".doc");
